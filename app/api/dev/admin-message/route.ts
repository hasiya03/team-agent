...
export async function POST(request: Request) {
  try {
    ...
    console.error("[dev:admin-message:error]", error);
    return Response.json({ reply: "I hit a temporary system error while handling that message. Please try again in a moment." }, { status: 200 });
  }
}
